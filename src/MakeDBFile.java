    ...
    */
    ...
    MakeDBFile() {
        try {
            ...
            //др.словами: подключаем базу данных, получая объект Connection:
            Connection connect = DriverManager.getConnection(SQLITE_DB);
            // сreates an object for sending SQL statements to the database (создаёт объект для отправки SQL-апросов):
